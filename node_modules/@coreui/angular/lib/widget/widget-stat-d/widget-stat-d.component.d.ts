...
export declare type WidgetStatDValue = {
    title?: string;
    value?: number | string;
};
export declare class WidgetStatDComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<WidgetStatDComponent, "c-widget-stat-d", ["cWidgetStatD"], { "color": "color"; "values": "values"; }, {}, never, ["*"], false, never>;
}
