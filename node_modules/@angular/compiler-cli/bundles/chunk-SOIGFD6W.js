...
var ClusterWorkerScriptResolver = class {
  static resolve(fileSystem) {
    const requireFn = module2.createRequire(import.meta.url);
...
var LockFilePathResolver = class {
  static resolve(fs) {
    const requireFn = module3.createRequire(import.meta.url);
...
var LockFileWithChildProcess = class {
  ...
  createUnlocker(path) {
    ...
    const unlocker = fork(LockFileUnlockerScriptResolver.resolve(this.fs), [path, logLevel], { detached: true, stdio: isWindows ? "pipe" : "inherit" });
    if (isWindows) {
...
var LockFileUnlockerScriptResolver = class {
  static resolve(fs) {
    const requireFn = module4.createRequire(import.meta.url);
...
var NgccConfiguration = class {
  ...
  evalSrcFile(srcPath) {
    const requireFn = module5.createRequire(import.meta.url);
 ...
 */
//# sourceMappingURL=chunk-SOIGFD6W.js.map
